...
public class UserDTO {
    ...
    public UserDTO(Long id, String name, String lastName, String email, String phoneNumber, String location, Role role, Date createdAt, Date updatedAt, Password password) {
        this.id = id;
        this.name = name;
        this.lastName = lastName;
        this.email = email;
